...
module.functions <- list(
  ...
  'firebrick4'="(c) Carbohydrate metabolism,\nvesicle transport", #Steroid metabolism"
...
tiff(file="../manuscript/PLOS-Climate-submission/Revision/Final/Figures-correct-dims/fig5.tiff", height = 6.7, width = 3.72, units = "in", res = 600)
MEs %>% 

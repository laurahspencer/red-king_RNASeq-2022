...
write.csv(geneInfo.mwu[,c("id", "gene_ontology_i_ds")], "../results/wgcna/genes_for-GOMWU.csv", quote = F,row.names = F)
...
for (i in 1:length(modules)) {
  ...
  write.csv(geneInfo.mwu.mods[[i]], paste("../results/wgcna/module_",modules[[i]],"_for-GOMWU.csv"), quote = F,row.names = F)
}

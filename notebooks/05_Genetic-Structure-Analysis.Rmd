...
snpgdsCreateGenoSet(src.fn="../results/genotype/genotypes.gds",
                    dest.fn="../results/genotype/genotypes-4Colony.gds",
...
geno.matrix4Colony <- snpgdsGetGeno(gdsobj="../results/genotype/genotypes-4Colony.gds", with.id=TRUE)
...
write_delim(cbind(sampleID=paste("O", geno.matrix4Colony$sample.id, sep=""),
            ...
            file="../results/genotype/geno.matrix.tab", delim="   ", col_names=FALSE)
```
